...
| PATH launchers | `bin/rocmplete`, `bin/opencode`, `bin/pi`, `bin/maki` |
| Agent model policy and sandbox | `src/rocmplete/agent_models.py`, `src/rocmplete/agent_sandbox.py` |
| Runtime client configuration | `src/rocmplete/opencode.py`, `src/rocmplete/pi_agent.py`, `src/rocmplete/maki_agent.py` |
